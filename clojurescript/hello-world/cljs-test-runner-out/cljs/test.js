...
var G__3236 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__3236,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__3236;
}
}));
...
var len__4736__auto___3241 = arguments.length;
var i__4737__auto___3242 = (0);
while(true){
if((i__4737__auto___3242 < len__4736__auto___3241)){
args__4742__auto__.push((arguments[i__4737__auto___3242]));

var G__3243 = (i__4737__auto___3242 + (1));
i__4737__auto___3242 = G__3243;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq3238){
var G__3239 = cljs.core.first.call(null,seq3238);
var seq3238__$1 = cljs.core.next.call(null,seq3238);
var G__3240 = cljs.core.first.call(null,seq3238__$1);
var seq3238__$2 = cljs.core.next.call(null,seq3238__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3239,G__3240,seq3238__$2);
}));
...
var map__3245 = m;
var map__3245__$1 = (((((!((map__3245 == null))))?(((((map__3245.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3245.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3245):map__3245);
var file = cljs.core.get.call(null,map__3245__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__3245__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__3245__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__3244_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__3244_SHARP_));
...
var temp__5735__auto___3247 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___3247)){
var message_3248 = temp__5735__auto___3247;
cljs.core.println.call(null,message_3248);
} else {
}
...
var temp__5735__auto___3249 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___3249)){
var message_3250 = temp__5735__auto___3249;
cljs.core.println.call(null,message_3250);
} else {
}
...
var output_dir__$1 = (function (){var G__3251 = output_dir;
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__3253 = exception.stack;
var G__3253__$1 = (((G__3253 == null))?null:clojure.string.split_lines.call(null,G__3253));
var G__3253__$2 = (((G__3253__$1 == null))?null:cljs.core.get.call(null,G__3253__$1,depth));
if((G__3253__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__3253__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__3254 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__3254,(0),null);
var column = cljs.core.nth.call(null,vec__3254,(1),null);
var vec__3257 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__3257,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__3257,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__3257,(2),null);
...
var m__$1 = (function (){var G__3260 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__3260__$1 = (((G__3260 instanceof cljs.core.Keyword))?G__3260.fqn:null);
switch (G__3260__$1) {
case "fail":
...
var G__3264 = (function (){var G__3263 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__3263);
} else {
return G__3263;
}
})();
...
return cljs.core.vary_meta.call(null,G__3265,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__3269 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__3269,(0),null);
var types = vec__3269;
...
return cljs.core.map.call(null,(function (p__3272){
var vec__3273 = p__3272;
var ns = cljs.core.nth.call(null,vec__3273,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__3273,(1),null);
return (function (){
...
var G__3276 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__3276__$1 = (((G__3276 instanceof cljs.core.Keyword))?G__3276.fqn:null);
switch (G__3276__$1) {
case "async":
...
var seq__3277 = cljs.core.seq.call(null,vars__$1);
var chunk__3278 = null;
var count__3279 = (0);
var i__3280 = (0);
while(true){
if((i__3280 < count__3279)){
var v = cljs.core._nth.call(null,chunk__3278,i__3280);
var temp__5735__auto___3282 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___3282)){
var t_3283 = temp__5735__auto___3282;
each_fixture_fn.call(null,((function (seq__3277,chunk__3278,count__3279,i__3280,t_3283,temp__5735__auto___3282,v,each_fixture_fn,G__3276,G__3276__$1,env,once_fixtures,each_fixtures,vec__3273,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_3283)));
});})(seq__3277,chunk__3278,count__3279,i__3280,t_3283,temp__5735__auto___3282,v,each_fixture_fn,G__3276,G__3276__$1,env,once_fixtures,each_fixtures,vec__3273,ns,vars__$1))
);
} else {
}


var G__3284 = seq__3277;
var G__3285 = chunk__3278;
var G__3286 = count__3279;
var G__3287 = (i__3280 + (1));
seq__3277 = G__3284;
chunk__3278 = G__3285;
count__3279 = G__3286;
i__3280 = G__3287;
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__3277);
if(temp__5735__auto__){
var seq__3277__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__3277__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__3277__$1);
var G__3288 = cljs.core.chunk_rest.call(null,seq__3277__$1);
var G__3289 = c__4556__auto__;
var G__3290 = cljs.core.count.call(null,c__4556__auto__);
var G__3291 = (0);
seq__3277 = G__3288;
chunk__3278 = G__3289;
count__3279 = G__3290;
...
var v = cljs.core.first.call(null,seq__3277__$1);
var temp__5735__auto___3292__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___3292__$1)){
var t_3293 = temp__5735__auto___3292__$1;
each_fixture_fn.call(null,((function (seq__3277,chunk__3278,count__3279,i__3280,t_3293,temp__5735__auto___3292__$1,v,seq__3277__$1,temp__5735__auto__,each_fixture_fn,G__3276,G__3276__$1,env,once_fixtures,each_fixtures,vec__3273,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_3293)));
});})(seq__3277,chunk__3278,count__3279,i__3280,t_3293,temp__5735__auto___3292__$1,v,seq__3277__$1,temp__5735__auto__,each_fixture_fn,G__3276,G__3276__$1,env,once_fixtures,each_fixtures,vec__3273,ns,vars__$1))
);
} else {
}


var G__3294 = cljs.core.next.call(null,seq__3277__$1);
var G__3295 = null;
var G__3296 = (0);
var G__3297 = (0);
seq__3277 = G__3294;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3276__$1)].join('')));
